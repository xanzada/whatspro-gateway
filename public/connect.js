(function () {
  ...
  var text = {
    kk: {
      ...
      callsCopy: 'Бұл екінші код — қоңыраулар үшін. WhatsApp кіріс қоңырауды бірінші құрылғыға көрсетпейді, сондықтан бот тағы бір байланысқан құрылғыны талап етеді. Сканерленген соң: клиент звандағанда қоңырау бір секунд өтеді, бот оны басып тастайды және клиентке бірден жауап хабарламасын жібереді. Сол телефонмен, осы беттен кетпей сканерлеңіз.',
    ...
    ru: {
      ...
      callsCopy: 'Второй код — для звонков. WhatsApp не показывает входящий звонок первому устройству, поэтому боту нужно ещё одно связанное устройство. После сканирования: когда клиент звонит, звонок идёт одну секунду, бот его сбрасывает и сразу отправляет клиенту сообщение. Сканируйте тем же телефоном, не уходя со страницы.',
