(function () {
  ...
  var dictionary = {
    kk: {
      ...
      client: 'Клиент', bot: 'Бот', operatorRole: 'Оператор', system: 'Жүйе', unknown: 'Контакт аты белгісіз',
    ...
    ru: {
      ...
      client: 'Клиент', bot: 'Бот', operatorRole: 'Оператор', system: 'Система', unknown: 'Имя контакта неизвестно',
